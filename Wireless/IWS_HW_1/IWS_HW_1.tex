...
$\lambda$ = $\frac{\sum{CallInitiationTime}}{NumberOfUsers}$ = $\frac{10}{0+2+0+3+1+7+4+2+5+1}$ = \pgfmathparse{10/(2+3+1+7+4+2+5+1)}\pgfmathresult\\

$\mu$ = $\frac{\sum{CallHoldingTime}}{NumberOfUsers}$ = $\frac{10}{5+7+4+8+6+2+1+4+3+2}$ = \pgfmathparse{10/(5+7+4+8+6+2+1+4+3+2)}\pgfmathresult\\

$W_s$ = Average dwell time\\

$W_s$ = $\frac{1}{\mu-\lambda}$ = \pgfmathparse{1/(10/(5+7+4+8+6+2+1+4+3+2)-10/(2+3+1+7+4+2+5+1))}\pgfmathresult\\
